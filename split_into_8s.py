...
output_folder = 'E:/MSc Research/MSc project/github_repo/datasets/Sarasangi/8s'

def split_wav(file_path, output_folder, clip_length=8):
    audio = AudioSegment.from_wav(file_path)

    total_length = len(audio) / 1000
    num_clips = int(total_length // clip_length)
...
split_wav(input_folder_path, output_folder, clip_length=7.5)